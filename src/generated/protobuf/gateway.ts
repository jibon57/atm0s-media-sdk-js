  ...
  fromPartial<I extends Exact<DeepPartial<ConnectRequest>, I>>(
    ...
    message.join =
      object.join !== undefined && object.join !== null
        ? RoomJoin.fromPartial(object.join)
        : undefined;
    message.tracks =
...
export const ConnectResponse = {
  ...
  fromJSON(object: any): ConnectResponse {
    return {
      ...
      sdp: isSet(object.sdp) ? globalThis.String(object.sdp) : '',
      iceLite: isSet(object.iceLite)
        ? globalThis.Boolean(object.iceLite)
        : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ConnectResponse>, I>>(
    base?: I,
  ): ConnectResponse {
...
export const RemoteIceRequest = {
  ...
  create<I extends Exact<DeepPartial<RemoteIceRequest>, I>>(
    base?: I,
  ): RemoteIceRequest {
    return RemoteIceRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RemoteIceRequest>, I>>(
    object: I,
  ): RemoteIceRequest {
    const message = createBaseRemoteIceRequest();
...
export const RemoteIceResponse = {
  ...
  create<I extends Exact<DeepPartial<RemoteIceResponse>, I>>(
    base?: I,
  ): RemoteIceResponse {
    return RemoteIceResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RemoteIceResponse>, I>>(
    object: I,
  ): RemoteIceResponse {
    const message = createBaseRemoteIceResponse();
