...
export const Config = {
  ...
  fromJSON(object: any): Config {
    return {
      ...
      outputs: globalThis.Array.isArray(object?.outputs)
        ? object.outputs.map((e: any) => globalThis.String(e))
        : [],
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.sources =
      object.sources?.map((e) => Receiver_Source.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): Request {
    return {
      attach: isSet(object.attach)
        ? Request_Attach.fromJSON(object.attach)
        : undefined,
      detach: isSet(object.detach)
        ? Request_Detach.fromJSON(object.detach)
        : undefined,
    };
  },
...
export const Request_Attach = {
  ...
  create<I extends Exact<DeepPartial<Request_Attach>, I>>(
    base?: I,
  ): Request_Attach {
    return Request_Attach.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Request_Attach>, I>>(
    object: I,
  ): Request_Attach {
    const message = createBaseRequest_Attach();
    message.sources =
...
export const Request_Detach = {
  ...
  create<I extends Exact<DeepPartial<Request_Detach>, I>>(
    base?: I,
  ): Request_Detach {
    return Request_Detach.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Request_Detach>, I>>(
    object: I,
  ): Request_Detach {
    const message = createBaseRequest_Detach();
    message.sources =
...
export const Response = {
  ...
  fromJSON(object: any): Response {
    return {
      attach: isSet(object.attach)
        ? Response_Attach.fromJSON(object.attach)
        : undefined,
      detach: isSet(object.detach)
        ? Response_Detach.fromJSON(object.detach)
        : undefined,
    };
  },
...
export const Response_Attach = {
  ...
  create<I extends Exact<DeepPartial<Response_Attach>, I>>(
    base?: I,
  ): Response_Attach {
    return Response_Attach.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Response_Attach>, I>>(
    _: I,
  ): Response_Attach {
    const message = createBaseResponse_Attach();
    return message;
...
export const Response_Detach = {
  ...
  create<I extends Exact<DeepPartial<Response_Detach>, I>>(
    base?: I,
  ): Response_Detach {
    return Response_Detach.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Response_Detach>, I>>(
    _: I,
  ): Response_Detach {
    const message = createBaseResponse_Detach();
    return message;
...
export const ServerEvent = {
  encode(
    ...
    if (message.slotSet !== undefined) {
      ServerEvent_SlotSet.encode(
        message.slotSet,
        writer.uint32(10).fork(),
      ).ldelim();
    }
    if (message.slotUnset !== undefined) {
      ServerEvent_SlotUnset.encode(
        message.slotUnset,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.slotUnset = ServerEvent_SlotUnset.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): ServerEvent {
    return {
      slotSet: isSet(object.slotSet)
        ? ServerEvent_SlotSet.fromJSON(object.slotSet)
        : undefined,
      slotUnset: isSet(object.slotUnset)
        ? ServerEvent_SlotUnset.fromJSON(object.slotUnset)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ServerEvent>, I>>(
    ...
    const message = createBaseServerEvent();
    message.slotSet =
      object.slotSet !== undefined && object.slotSet !== null
        ? ServerEvent_SlotSet.fromPartial(object.slotSet)
        : undefined;
    message.slotUnset =
      object.slotUnset !== undefined && object.slotUnset !== null
...
export const ServerEvent_SlotSet = {
  ...
  create<I extends Exact<DeepPartial<ServerEvent_SlotSet>, I>>(
    base?: I,
  ): ServerEvent_SlotSet {
    return ServerEvent_SlotSet.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServerEvent_SlotSet>, I>>(
    object: I,
  ): ServerEvent_SlotSet {
    const message = createBaseServerEvent_SlotSet();
...
export const ServerEvent_SlotUnset = {
  ...
  create<I extends Exact<DeepPartial<ServerEvent_SlotUnset>, I>>(
    base?: I,
  ): ServerEvent_SlotUnset {
    return ServerEvent_SlotUnset.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServerEvent_SlotUnset>, I>>(
    object: I,
  ): ServerEvent_SlotUnset {
    const message = createBaseServerEvent_SlotUnset();
    message.slot = object.slot ?? 0;
